...
export abstract class PermissionRepository {
    ...
    abstract find(id: number, options?: QueryOptions): Promise<Permission | null>;

    abstract findOneBy(conditions: Record<string, unknown>, options?: QueryOptions): Promise<Permission | null>;

    abstract first(options?: QueryOptions): Promise<Permission | null>;

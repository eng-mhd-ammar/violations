...
export class PermissionsController {
    ...
    async findAll(@Res() res: ExpressResponse) {
        ...
        const data = PermissionResource.collection(permissions);
    ...
    async findOne(
        ...
        const permission =
            await this.permissionsService.findById(id);
    ...
    async forceDelete(
        ...
        const permission =
            await this.permissionsService.forceDelete(id);
        ...
        return new ResponseUtil(
            ...
            data,
            'Permission force deleted successfully',
            ResponseUtil.HTTP_OK,
        );
    }
}

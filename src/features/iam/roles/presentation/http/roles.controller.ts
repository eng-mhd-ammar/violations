...
export class RolesController {
    ...
    */
    @Can('roles_create')
    @Post()
    async create(@Body() dto: CreateRoleDto, @Res() res: ExpressResponse) {
        const role = await this.rolesService.create(dto);
        const data = RoleResource.make(role);

        return new ResponseUtil(res).success(data, 'Role created successfully', ResponseUtil.HTTP_CREATED);
    }
    ...
    */
    ...
    async findOne(@Param('id', ParseIntPipe) id: number, @Res() res: ExpressResponse, @Query() query: QueryDto) {
        ...
        const data = RoleResource.make(service);

        return new ResponseUtil(res).success(data, 'Role retrieved successfully', ResponseUtil.HTTP_OK);
    }
    ...
    */
    @Can('roles_update')
    @Patch(':id')
    async update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateRoleDto, @Res() res: ExpressResponse) {
        const role = await this.rolesService.update(id, dto);
        const data = RoleResource.make(role);

        return new ResponseUtil(res).success(data, 'Role updated successfully', ResponseUtil.HTTP_OK);
    }
    ...
    */
    ...
    async delete(@Param('id', ParseIntPipe) id: number, @Res() res: ExpressResponse,) {
        ...
        return new ResponseUtil(res).success(data, 'Role deleted successfully', ResponseUtil.HTTP_OK);
    }
    ...
    */
    ...
    async restore(@Param('id', ParseIntPipe) id: number, @Res() res: ExpressResponse) {
        ...
        return new ResponseUtil(res).success(data, 'Role restored successfully', ResponseUtil.HTTP_OK);
    }
    ...
    */
    ...
    async forceDelete(@Param('id', ParseIntPipe) id: number, @Res() res: ExpressResponse) {
        ...
        return new ResponseUtil(res).success(data, 'Role force deleted successfully', ResponseUtil.HTTP_OK);
    }
}